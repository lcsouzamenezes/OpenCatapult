...
namespace Polyrific.Catapult.Engine.UnitTests.Core.JobTasks
{
    public class CustomTaskTests
    {
        ...
        public CustomTaskTests()
        {
            ...
            {
                new TaskProviderItem("FakeGenericTaskProvider", "path/to/FakeGenericTaskProvider.dll", new string[] { })
            });
        ...
        public async void RunMainTask_AdditionalConfigSecured()
        {
            ...
            _taskProviderManager.Setup(p => p.GetTaskProviders(It.IsAny<string>())).Returns(new List<TaskProviderItem>
            {
                new TaskProviderItem("FakeGenericTaskProvider", "path/to/FakeGenericTaskProvider.dll", new string[] { "GitHub" })
            });
