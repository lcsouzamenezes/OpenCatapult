...
namespace Polyrific.Catapult.Engine.UnitTests.Core.JobTasks
{
    public class DeleteRepositoryTaskTests
    {
        ...
        public async void RunMainTask_Success()
        {
            ...
            var task = new DeleteRepositoryTask(_projectService.Object, _externalServiceService.Object, _externalServiceTypeService.Object, _providerService.Object, _taskProviderManager.Object, _logger.Object);
