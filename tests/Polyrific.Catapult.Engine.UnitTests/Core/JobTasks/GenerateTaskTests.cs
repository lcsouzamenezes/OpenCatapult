...
namespace Polyrific.Catapult.Engine.UnitTests.Core.JobTasks
{
    public class GenerateTaskTests
    {
        ...
        public GenerateTaskTests()
        {
            ...
            {
                new TaskProviderItem("FakeCodeGeneratorProvider", "path/to/FakeCodeGeneratorProvider.dll", new string[] { })
            });
        ...
        public async void RunMainTask_Success()
        {
            ...
            var task = new GenerateTask(_projectService.Object, _externalServiceService.Object, _externalServiceTypeService.Object, _providerService.Object, _dataModelService.Object, _taskProviderManager.Object, _logger.Object);
        ...
        public async void RunMainTask_AdditionalConfigSecured()
        {
            ...
            _taskProviderManager.Setup(p => p.GetTaskProviders(It.IsAny<string>())).Returns(new List<TaskProviderItem>
            {
                new TaskProviderItem("FakeCodeGeneratorProvider", "path/to/FakeCodeGeneratorProvider.dll", new string[] { "GitHub" })
            });
