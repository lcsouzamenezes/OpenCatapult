...
namespace Polyrific.Catapult.Cli.Commands.Job
{
    ...
    public class GetCommand : BaseCommand
    {
        ...
        public GetCommand(IConsole console, ILogger<GetCommand> logger,
            IProjectService projectService, IJobDefinitionService jobDefinitionService, IProviderService providerService) : base(console, logger)
        {
            ...
            if (project != null)
            {
                ...
                if (job != null)
                {
                    ...
                    if (job.Tasks?.Count > 0)
                    {
                        ...
                        {
                            var configs = _providerService.GetProviderAdditionalConfigByProviderName(task.Provider).Result;
