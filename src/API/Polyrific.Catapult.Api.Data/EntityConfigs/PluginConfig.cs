    ...
    public class PluginConfig : BaseEntityConfig<Plugin>
    {
        public override void Configure(EntityTypeBuilder<Plugin> builder)
        {
            ...
            builder.HasData(
                ...
                new Plugin { Id = 2, Name = "Polyrific.Catapult.TaskProviders.GitHub", Type = "RepositoryProvider", Author = "Polyrific", Version = "1.0.0-beta2", RequiredServicesString = "GitHub", Created = new DateTime(2018, 9, 28, 7, 23, 37, 58, DateTimeKind.Utc), ConcurrencyStamp = "976e0533-360a-4e46-8220-7c1cfdf0e0a2" },
