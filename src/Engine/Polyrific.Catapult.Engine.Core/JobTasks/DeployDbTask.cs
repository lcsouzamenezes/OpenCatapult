...
namespace Polyrific.Catapult.Engine.Core.JobTasks
{
    ...
    {
        /// <inheritdoc />
        public DeployDbTask(IProjectService projectService, IExternalServiceService externalServiceService, IExternalServiceTypeService externalServiceTypeService, IProviderService providerService, ITaskProviderManager taskProviderManager, ILogger<DeployDbTask> logger)
        ...
        public List<TaskProviderItem> DatabaseProviders => TaskProviderManager.GetTaskProviders(TaskProviderType.DatabaseProvider);
